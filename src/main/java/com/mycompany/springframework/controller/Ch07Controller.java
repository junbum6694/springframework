...
public class Ch07Controller {
	...
	public String objctScope1(HttpServletRequest request, HttpSession session, Model model) {
		...
		//Session 사용범위(같은 브라우저에서 사용할 수 있는 범위)
	...
	public String objctScope2(HttpServletRequest request, HttpSession session, Model model) {
