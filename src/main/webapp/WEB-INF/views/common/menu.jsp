...
<div class="accordion" id="accordionMenu">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button ${chNum=='ch03'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch03" aria-expanded="${chNum=='ch02'}" aria-controls="ch03">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button class="accordion-button ${chNum=='ch09'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch09" aria-expanded="${chNum=='ch09'}" aria-controls="ch08">
        Ch09. 파일 업로드와 다운로드
      </button>
    </h2>
    ...
    <div id="ch10" class="accordion-collapse collapse ${chNum=='ch10'?'show':''}" data-bs-parent="#accordionMenu">
      <div class="accordion-body">
        <ul>
        	...
        	<li><a href="${pageContext.request.contextPath}/ch10/handlingException2">@ExceoptionHandler이용</a></li>
        	<li><a href="${pageContext.request.contextPath}/ch10/handlingException3">사용자 정의 예외처리</a></li>
  ...
  <div class="accordion-item">
    ...
    <div id="ch12" class="accordion-collapse collapse ${chNum=='ch12'?'show':''}" data-bs-parent="#accordionMenu">
      <div class="accordion-body">
        <ul>
        	<li><a href="${pageContext.request.contextPath}/ch12/createBeanByXml">XML 설정으로 관리 빈(객체) 생성</a></li>
		</ul>
      </div>
    </div>
  </div> 
