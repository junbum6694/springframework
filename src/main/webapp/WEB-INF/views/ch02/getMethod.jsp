...
<div class="card">
	...
	<div class="card-body">
		<div>
			...
			<a href="getAtag?bno=5&bkind=free">링크2</a>
		</div>
		<hr>	
		<div class="mt-2">
		...
		<hr>
		<div class="mt-2">
			<button onclick="requestGet1()" class="btn btn-info btn-sm mb-2">Javasript: location.href 속성이용</button>
			<br><br>
			<button onclick="requestGet2()" class="btn btn-info btn-sm mb-2">Javasript: AJAX 속성이용</button>
			<button onclick="requestGet3()" class="btn btn-info btn-sm mb-2">Javasript: AJAX 속성이용</button>
