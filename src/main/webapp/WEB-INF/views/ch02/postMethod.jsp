...
<div class="card">
	...
	<div class="card-body">
		...
		<form method="post" action="postFormTag">
			...
			<br>
			<%-- 제출버튼을 만드는 방법2 --%>
			<input class="mt-2" type="image" src="${pageContext.request.contextPath}/resources/image/submit.gif">
			<br>
			<%-- 제출버튼을 만드는 방법3 button이 form태그 안에 있을 경우 default로 submit을 가진다.--%>
		...
		<div class="mt-2">
			<button onclick="requestPost1()" class="btn btn-info btn-sm mb-2">Javasript: AJAX 속성이용</button>
			<button onclick="requestPost2()" class="btn btn-info btn-sm mb-2">Javasript: AJAX 속성이용</button>
